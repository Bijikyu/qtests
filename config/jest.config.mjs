...
export default {
  ...
  "^\\.\\./utils/errorHandling\\.js$": "<rootDir>/lib/utils/errorHandling.ts",
  "^\\.\\./utils/memoryManagement\\.js$": "<rootDir>/lib/utils/memoryManagement.ts",
  "^\\.\\./utils/httpMockFramework\\.js$": "<rootDir>/lib/utils/httpMockFramework.ts",
  "^\\.\\./utils/validationSchemas\\.js$": "<rootDir>/lib/utils/validationSchemas.ts",
  "^\\.\\./utils/timingUtils\\.js$": "<rootDir>/lib/utils/timingUtils.ts",
  "^\\./httpTest\\.shim\\.js$": "<rootDir>/utils/httpTest.shim.ts",
