...
class TestRunner {
  ...
  // Run a single test file with Jest optimization
  ...
  // Generate DEBUG_TESTS.md for failed tests
  generateDebugFile() {
  ...
  // Main runner with parallel execution and batching
  async run() {
    ...
    // Parallel execution with CPU-based concurrency
