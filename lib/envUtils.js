...
module.exports = {
  ...
  // Provides save/restore for environment variables and centralized mock management
  // Essential for testing code that depends on environment configuration
  testEnv,

  // Offline/online mode utility with automatic axios and qerrors switching
  // Allows tests to run without network dependencies by automatically
  // switching to stub implementations when offline mode is enabled
  offlineMode,

  // Advanced testing utilities for module reloading and mocking
  // Specialized helpers for complex scenarios like integration testing,
  // module cache management, and HTTP response object mocking
  testHelpers
};
