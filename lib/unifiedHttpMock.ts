/**
 * Unified HTTP Mock Factory
 * Consolidates and eliminates duplication between mockAxios.ts and httpClientMockFactory.ts
 * Provides a single, comprehensive HTTP mocking solution with multiple strategies
 * 
 * This file replaces ~900 lines of duplicate code with a clean, unified interface
 * while preserving all functionality from both original implementations.
 */
 ...
 * @deprecated Use createMockHttpClient instead
 */
...
/**
 * Unified HTTP mock factory interface
 * Consolidates all HTTP mocking functionality in one place
 */
