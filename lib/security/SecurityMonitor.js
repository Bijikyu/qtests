...
export class SecurityMonitor {
    ...
    /**
     * Enforce memory bounds for events array
     */
    enforceEventBounds() {
    ...
    /**
     * Enforce memory bounds for rate limits map
     */
    enforceRateLimitBounds() {
        if (this.rateLimits.size > this.maxRateLimits) {
            ...
            const excess = this.rateLimits.size - this.maxRateLimits;
