...
module.exports = {
  ...
  // This is the most fundamental operation in testing - replacing a method
  // with a controlled implementation to eliminate external dependencies
  stubMethod,

  // Console output capture for testing logging behavior without cluttering test output
  // Essential for testing functions that log information, errors, or debug data
  // without polluting the test runner's console output
  mockConsole
};
