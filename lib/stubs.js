 ...
 */
module.exports = {
  // HTTP client stub for network-free testing
  // Replaces axios with a stub that returns predictable responses
  // without making actual HTTP requests. Essential for isolated unit testing.
  axios: require('../stubs/axios'),

  // Logging library stub for output-free testing
  // Replaces winston with a stub that captures log calls without output
  // Prevents test console pollution while allowing log behavior verification
  winston: require('../stubs/winston')
  
  // Future stubs can be added here following the same pattern:
  // moduleName: require('../stubs/moduleName')
  // This provides a clear extension point for additional stub modules
};
