...
**Dominant Dirs:** lib (9), lib/fileSystem (6), utils (6)
**Internal Deps:** 3
...
## [9] `lib/qerrorsFallback.js`
**Type:** Code File
**Functions:** qerrors

---

## [10] `lib/errorHandling/pRetryTimeoutWrapper.ts`
**Type:** Code File
...
## [11] `lib/fileSystem/errorHandling.ts`
**Type:** Code File
...
## [12] `lib/fileSystem/fileDeletion.ts`
**Type:** Code File
...
## [13] `lib/fileSystem/fileExistence.ts`
**Type:** Code File
...
## [14] `lib/fileSystem/fileReading.ts`
**Type:** Code File
**Imports:** ../qerrorsFallback.js, fs-extra
...
## [15] `lib/fileSystem/fileWriting.ts`
**Type:** Code File
**Imports:** ../qerrorsFallback.js, fs-extra
...
## [16] `lib/fileSystem/managementUtils.ts`
**Type:** Code File
...
## [17] `lib/httpMock/clientFactories.ts`
**Type:** Code File
...
## [18] `lib/httpMock/legacyAxiosImplementation.ts`
**Type:** Code File
...
## [19] `lib/httpMock/mockUtilities.ts`
**Type:** Code File
...
## [20] `lib/httpMock/serverFactories.ts`
**Type:** Code File
**Imports:** ../qerrorsFallback.js, ./mockTypes.js, module, msw, msw/node
...
## [21] `lib/httpMock/userConfigurableAxiosMock.ts`
**Type:** Code File
...
## [22] `lib/memory/moduleCleanup.ts`
**Type:** Code File
...
## [23] `lib/memory/snapshotManager.ts`
**Type:** Code File
...
## [24] `lib/security/SecurityPolicyManager.ts`
**Type:** Code File
**Imports:** ../qerrorsFallback.js
...
## [25] `lib/security/securityHeaders.ts`
**Type:** Code File
...
## [26] `lib/testIsolation/databaseManager.ts`
**Type:** Test File
**Imports:** ../qerrorsFallback.js
...
## [27] `lib/testIsolation/environmentManager.ts`
**Type:** Test File
**Imports:** ../qerrorsFallback.js
...
## [28] `lib/testIsolation/serverManager.ts`
**Type:** Test File
**Imports:** ../qerrorsFallback.js
...
## [30] `lib/utils/streamingUtils.ts`
**Type:** Utility
...
## [31] `lib/validation/htmlSanitization.ts`
**Type:** Code File
**Imports:** ../qerrorsFallback.js
...
## [32] `lib/validation/streamingValidator.ts`
**Type:** Code File
...
## [33] `lib/validation/validationLogic.ts`
**Type:** Code File
...
## [34] `lib/validation/validationMiddleware.ts`
**Type:** Code File
...
## [35] `utils/testing/assertionHelper.ts`
**Type:** Test File
**Imports:** ../../lib/logUtils.js, ../../lib/qerrorsFallback.js, ../helpers/validation.js
**Exports:** AssertionHelper
**Dependencies:** lib/qerrorsFallback.js

---

## [36] `utils/testing/portAllocator.ts`
**Type:** Test File
...
## [37] `lib/advancedMemoryLeakDetector.ts`
**Type:** Code File
...
## [42] `utils/offlineMode.ts`
**Type:** Utility
**Imports:** ../config/localVars.js, ../lib/qerrorsFallback.js
...
## [43] `lib/streamingValidatorModern.ts`
**Type:** Code File
...
## [48] `utils/httpClientMockFactory.ts`
**Type:** Utility
...
## [51] `tests/integration/frontend-backend-compatibility.test.js`
**Type:** Test File
...
## [53] `examples/runTestSuite-demo.js`
**Type:** Code File
**Imports:** ../index
...
## [54] `examples/test-generator-demo.js`
**Type:** Test File
...
## [57] `examples/security-integration-example.ts`
**Type:** Code File
...
## [58] `lib/security/SecurityValidator.js`
**Type:** Code File
...
## [59] `lib/security/SecurityMiddleware.ts`
**Type:** Code File
...
## [60] `lib/security/SecurityPolicyManager.js`
**Type:** Code File
**Imports:** qerrors
...
## [61] `lib/security/SecurityTestingFramework.js`
**Type:** Code File
...
## [63] `lib/security/SecurityMonitor.js`
**Type:** Code File
**Imports:** qerrors
...
## [64] `lib/security/JoiSecurityValidator.ts`
**Type:** Code File
...
## [65] `lib/security/SecurityAnalytics.ts`
**Type:** Code File
...
## [66] `lib/security/SecurityAnalyticsTypes.ts`
**Type:** Code File
**Imports:** ./SecurityMonitor.js
...
## [67] `lib/security/SecurityTestingFramework.ts`
**Type:** Code File
**Imports:** ./SecurityMonitor.js, ./SecurityPolicyManager.js, ./SecurityValidator.js
...
## [68] `lib/security/SecurityValidator.ts`
**Type:** Code File
...
## [86] `demo/server/routes/users.js`
**Type:** API/Route
...
## [87] `demo/server/routes/status.js`
**Type:** API/Route
**Imports:** express
...
## [89] `demo/server/routes/hello.js`
**Type:** API/Route
...
## [90] `demo/server/services/externalService.js`
**Type:** Code File
...
## [91] `demo/server/routes/calculator.js`
**Type:** API/Route
**Imports:** express
**API Calls:** router.delete, router.get, router.post, router.put
...
### 🧩 Flow Group: [13] `Similarity-axios`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [14] `Similarity-stubs`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [15] `Similarity-setup`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [16] `Similarity-utils-stubbing-types`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [17] `Similarity-lib-validation-index`
**Flow Type:** Similarity
**Files:** 9
...
## [103] `lib/validation/index.ts`
**Type:** Code File

---

## [104] `lib/testIsolation/index.ts`
**Type:** Test File

---

## [105] `lib/security/index.js`
**Type:** Code File
...
## [107] `lib/memory/index.ts`
**Type:** Code File
**Exports:** aggressiveCleanup, detectMemoryLeaks, memoryMonitor

---

## [108] `lib/logging/index.ts`
**Type:** Code File

---

## [109] `lib/httpMock/index.ts`
**Type:** Code File

---

## [110] `lib/fileSystem/index.ts`
**Type:** Code File
...
## [111] `lib/errorHandling/index.ts`
**Type:** Code File
...
### 🧩 Flow Group: [18] `Similarity-demo-client-index`
**Flow Type:** Similarity
**Files:** 1
...
## [112] `demo/client/index.html`
**Type:** Template/View
**Tags:** html, head, meta, title, body

---

### 🧩 Flow Group: [19] `Similarity-replit`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [20] `Similarity-README`
**Flow Type:** Similarity
**Files:** 3
...
### 🧩 Flow Group: [21] `Similarity-AGENTS`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [22] `Similarity-verify`
**Flow Type:** Similarity
**Files:** 2
...
## [118] `scripts/verify.js`
**Type:** Code File

---

## [119] `scripts/verify-npm-replacement.js`
**Type:** Code File
...
### 🧩 Flow Group: [23] `Similarity-spying`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [24] `Similarity-testEnv`
**Flow Type:** Similarity
**Files:** 5
...
## [124] `utils/testEnv/testMockFactory.ts`
**Type:** Test File
...
## [125] `utils/testEnv/testInitializer.ts`
**Type:** Test File
...
### 🧩 Flow Group: [25] `Similarity-summary`
**Flow Type:** Similarity
**Files:** 4
...
### 🧩 Flow Group: [26] `Similarity-winston`
**Flow Type:** Similarity
**Files:** 3
...
## [131] `__mocks__/winston.js`
**Type:** Code File
**Functions:** createLogger, noop

---

## [132] `stubs/winston.d.ts`
**Type:** Code File
**Exports:** FormatStub, LogEntry, LoggerOptions, LoggerStub, MockConsoleTransport, MockFileTransport, MockLogger, MockTimer (+5 more)

---

### 🧩 Flow Group: [27] `Similarity-logging`
**Flow Type:** Similarity
**Files:** 3
...
### 🧩 Flow Group: [28] `Similarity-package`
**Flow Type:** Similarity
**Files:** 3
...
## [138] `demo/package-lock.json`
**Type:** Configuration/Data
**Keys:** name, version, lockfileVersion, requires, packages

---

### 🧩 Flow Group: [29] `Similarity-SUMMARY`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [30] `Similarity-tsconfig`
**Flow Type:** Similarity
**Files:** 4
...
### 🧩 Flow Group: [32] `Similarity-SECURITY`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [33] `Similarity-httpTest`
**Flow Type:** Similarity
**Files:** 2
...
## [147] `utils/httpTest.ts`
**Type:** Utility
**Exports:** createMockApp, supertest

---

## [148] `utils/httpTest.shim.ts`
**Type:** Utility
**Exports:** createMockApp, supertest
...
### 🧩 Flow Group: [34] `Similarity-loadTest`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [35] `Similarity-envUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [36] `Similarity-mongoose`
**Flow Type:** Similarity
**Files:** 1
...
## [151] `__mocks__/mongoose.js`
**Type:** Code File
**Functions:** createFallbackFn, f

---

### 🧩 Flow Group: [37] `Similarity-fileMock`
**Flow Type:** Similarity
**Files:** 1
...
## [152] `__mocks__/fileMock.js`
**Type:** Code File

---

### 🧩 Flow Group: [38] `Similarity-sendEmail`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [39] `Similarity-broadcast`
**Flow Type:** Similarity
**Files:** 1
...
## [154] `scripts/broadcast.sh`
**Type:** Script
**Commands:** echo

---

### 🧩 Flow Group: [40] `Similarity-testUtils`
**Flow Type:** Similarity
**Files:** 3
...
### 🧩 Flow Group: [41] `Similarity-httpUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [42] `Similarity-dataUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [43] `Similarity-coreUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [161] `config/styleMock.js`
**Type:** Configuration

---

### 🧩 Flow Group: [45] `Similarity-qerrors-d`
**Flow Type:** Similarity
**Files:** 1
...
## [163] `utils/testing/mockUtils.ts`
**Type:** Test File
...
## [164] `utils/testing/mockManager.ts`
**Type:** Test File
...
### 🧩 Flow Group: [47] `Similarity-dataTypes`
**Flow Type:** Similarity
**Files:** 3
...
## [165] `utils/testing/dataTypes.ts`
**Type:** Test File
**Exports:** ApiKey, LogEntry, User

---

## [166] `utils/testing/datasetFactory.ts`
**Type:** Test File
...
## [167] `utils/testing/databaseTestHelper.ts`
**Type:** Test File
...
### 🧩 Flow Group: [48] `Similarity-utilities`
**Flow Type:** Similarity
**Files:** 1
...
## [168] `utils/stubbing/utilities.ts`
**Type:** Utility
...
### 🧩 Flow Group: [49] `Similarity-timeUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [169] `utils/helpers/timeUtils.ts`
**Type:** Utility
...
### 🧩 Flow Group: [50] `Similarity-jsonUtils`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [51] `Similarity-mockTypes`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [53] `Similarity-mockModels`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [54] `Similarity-index-test`
**Flow Type:** Similarity
**Files:** 1
...
## [177] `scripts/kill-agent.sh`
**Type:** Script
**Commands:** echo

---

## [178] `scripts/kill-all-agents.sh`
**Type:** Script
**Commands:** echo, find
...
## [180] `lib/memory/monitoringOrchestration.ts`
**Type:** Code File
...
## [182] `utils/testEnv/axiosMocks.ts`
**Type:** Test File
...
## [183] `utils/helpers/validation.ts`
**Type:** Utility
...
## [184] `utils/helpers/envManager.ts`
**Type:** Utility
**Imports:** dotenv
...
## [185] `utils/console/jestMocker.ts`
**Type:** Utility
...
### 🧩 Flow Group: [62] `Similarity-asyncUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [63] `Similarity-jestWorker`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [64] `Similarity-decorators`
**Flow Type:** Similarity
**Files:** 2
...
## [189] `lib/logging/decoratorTypes.ts`
**Type:** Code File
**Exports:** DEFAULT_OPTIONS, LoggingOptions

---

### 🧩 Flow Group: [65] `Similarity-errorTypes`
**Flow Type:** Similarity
**Files:** 5
**Entry Point:** lib/errorHandling/errorTypes.ts (roleScore 0)
**Dominant Dirs:** lib/errorHandling (4), lib/utils (1)
**Internal Deps:** 0

## [190] `lib/errorHandling/errorTypes.ts`
**Type:** Code File
...
## [191] `lib/errorHandling/errorLogging.ts`
**Type:** Code File
...
## [192] `lib/utils/errorHandling.js`
**Type:** Utility
**Imports:** qerrors
...
## [193] `lib/errorHandling/errorWrappers.ts`
**Type:** Code File
...
## [194] `lib/errorHandling/errorTransformation.ts`
**Type:** Code File
...
### 🧩 Flow Group: [66] `Similarity-jest-setup`
**Flow Type:** Similarity
**Files:** 4
...
## [195] `demo/config/jest-setup.ts`
**Type:** Configuration
**Imports:** @bijikyu/qtests/setup, @jest/globals

---

## [196] `demo/config/jest-setup.js`
**Type:** Configuration
**Imports:** module
...
## [198] `demo/jest.config.js`
**Type:** Configuration

---

### 🧩 Flow Group: [67] `Similarity-spawn-agent`
**Flow Type:** Similarity
**Files:** 1
...
## [199] `scripts/spawn-agent.sh`
**Type:** Script
**Commands:** echo, mkdir, printf

---

### 🧩 Flow Group: [68] `Similarity-list-agents`
**Flow Type:** Similarity
**Files:** 1
...
## [200] `scripts/list-agents.sh`
**Type:** Script
**Commands:** echo, find

---

### 🧩 Flow Group: [69] `Similarity-scalableApi`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [70] `Similarity-spyAttacher`
**Flow Type:** Similarity
**Files:** 1
...
## [203] `utils/testEnv/spyAttacher.ts`
**Type:** Test File
...
### 🧩 Flow Group: [71] `Similarity-mockFactory`
**Flow Type:** Similarity
**Files:** 1
...
## [204] `utils/testEnv/mockFactory.ts`
**Type:** Test File
...
### 🧩 Flow Group: [72] `Similarity-apiLogModel`
**Flow Type:** Similarity
**Files:** 2
...
## [205] `utils/models/apiLogModel.ts`
**Type:** API/Route
...
## [206] `utils/models/apiKeyModel.ts`
**Type:** API/Route
**Imports:** ./baseMockModel.js
...
### 🧩 Flow Group: [73] `Similarity-stringUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [207] `utils/helpers/stringUtils.ts`
**Type:** Utility
...
### 🧩 Flow Group: [74] `Similarity-qerrorsStub`
**Flow Type:** Similarity
**Files:** 1
...
## [208] `utils/helpers/qerrorsStub.ts`
**Type:** Utility
**Exports:** stubQerrors
...
### 🧩 Flow Group: [75] `Similarity-emailSender`
**Flow Type:** Similarity
**Files:** 5
...
## [209] `utils/email/emailSender.ts`
**Type:** Utility
...
## [210] `utils/email/emailHistory.ts`
**Type:** Utility
**Imports:** ../../lib/logUtils.js
...
## [211] `utils/email/emailTemplate.ts`
**Type:** Utility
**Imports:** ../../lib/logUtils.js
...
## [212] `utils/email/emailValidator.ts`
**Type:** Utility
**Imports:** ../../lib/logUtils.js
...
## [213] `utils/email/emailFormatter.ts`
**Type:** Utility
**Imports:** ../../lib/logUtils.js
...
### 🧩 Flow Group: [76] `Similarity-esm-globals`
**Flow Type:** Similarity
**Files:** 1
...
## [214] `utils/__mocks__/esm-globals.ts`
**Type:** Utility
**Imports:** path, url
...
### 🧩 Flow Group: [77] `Similarity-timingUtils`
**Flow Type:** Similarity
**Files:** 3
...
## [217] `lib/utils/__tests__/timingUtils.test.ts`
**Type:** Test File
**Imports:** ../timingUtils.js, @jest/globals

---

### 🧩 Flow Group: [78] `Similarity-mockManager`
**Flow Type:** Similarity
**Files:** 1
...
## [218] `lib/testIsolation/mockManager.ts`
**Type:** Test File
...
### 🧩 Flow Group: [79] `Similarity-memoryTypes`
**Flow Type:** Similarity
**Files:** 2
...
## [219] `lib/memory/memoryTypes.ts`
**Type:** Code File
**Exports:** MemoryDelta, MemorySnapshot

---

## [220] `lib/memory/memoryMonitoring.ts`
**Type:** Code File
...
### 🧩 Flow Group: [80] `Similarity-coreWrapper`
**Flow Type:** Similarity
**Files:** 1
...
## [221] `lib/logging/coreWrapper.ts`
**Type:** Code File
...
### 🧩 Flow Group: [81] `Similarity-vite-config`
**Flow Type:** Similarity
**Files:** 1
...
## [222] `demo/client/vite.config.ts`
**Type:** Configuration
...
### 🧩 Flow Group: [82] `Similarity-runTestSuite`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [83] `Similarity-qtestsConfig`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [84] `Similarity-serviceMocks`
**Flow Type:** Similarity
**Files:** 1
...
## [225] `utils/testEnv/serviceMocks.ts`
**Type:** Test File
...
### 🧩 Flow Group: [85] `Similarity-verification`
**Flow Type:** Similarity
**Files:** 1
...
## [226] `utils/stubbing/verification.ts`
**Type:** Utility
**Imports:** sinon
...
### 🧩 Flow Group: [86] `Similarity-mockCreation`
**Flow Type:** Similarity
**Files:** 1
...
## [227] `utils/stubbing/mockCreation.ts`
**Type:** Utility
**Exports:** createFake, createFakeServer, createFakeXHR, createMock, stubMethod

---

### 🧩 Flow Group: [87] `Similarity-modelFactory`
**Flow Type:** Similarity
**Files:** 1
...
## [228] `utils/models/modelFactory.ts`
**Type:** Utility
...
### 🧩 Flow Group: [88] `Similarity-mockResponse`
**Flow Type:** Similarity
**Files:** 1
...
## [229] `utils/http/mockResponse.ts`
**Type:** Utility
...
### 🧩 Flow Group: [89] `Similarity-promiseUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [230] `utils/helpers/promiseUtils.ts`
**Type:** Utility
...
### 🧩 Flow Group: [90] `Similarity-keyGenerator`
**Flow Type:** Similarity
**Files:** 1
...
## [231] `utils/helpers/keyGenerator.ts`
**Type:** Utility
**Imports:** crypto
**Exports:** generateKey
...
### 🧩 Flow Group: [91] `Similarity-consoleUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [232] `utils/console/consoleUtils.ts`
**Type:** Utility
...
### 🧩 Flow Group: [92] `Similarity-basicSchemas`
**Flow Type:** Similarity
**Files:** 1
...
## [234] `lib/memory/leakDetector.ts`
**Type:** Code File
...
### 🧩 Flow Group: [94] `Similarity-readingUtils`
**Flow Type:** Similarity
**Files:** 1
...
## [236] `scripts/send-to-agent.sh`
**Type:** Script
**Commands:** echo

---

### 🧩 Flow Group: [96] `Similarity-API-REFERENCE`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [97] `Similarity-functionMocks`
**Flow Type:** Similarity
**Files:** 1
...
## [238] `utils/testEnv/functionMocks.ts`
**Type:** Test File
...
### 🧩 Flow Group: [98] `Similarity-safeExecution`
**Flow Type:** Similarity
**Files:** 1
...
## [239] `utils/helpers/safeExecution.ts`
**Type:** Utility
...
### 🧩 Flow Group: [99] `Similarity-pathValidator`
**Flow Type:** Similarity
**Files:** 2
...
## [240] `lib/security/pathValidator.ts`
**Type:** Code File
...
## [241] `lib/security/__tests__/pathValidator.test.ts`
**Type:** Test File
**Imports:** ../pathValidator.js, @jest/globals, fs, path

---

### 🧩 Flow Group: [100] `Similarity-SecurityUtils`
**Flow Type:** Similarity
**Files:** 2
...
## [242] `lib/security/SecurityUtils.ts`
**Type:** Code File
**Imports:** crypto, fs, path, secure-json-parse
...
## [243] `lib/security/SecurityMonitor.ts`
**Type:** Code File
**Imports:** crypto
...
### 🧩 Flow Group: [101] `Similarity-globalCleanup`
**Flow Type:** Similarity
**Files:** 1
...
## [244] `lib/memory/globalCleanup.ts`
**Type:** Code File
...
### 🧩 Flow Group: [102] `Similarity-winstonLogger`
**Flow Type:** Similarity
**Files:** 1
...
## [245] `lib/logging/winstonLogger.ts`
**Type:** Code File
...
### 🧩 Flow Group: [103] `Similarity-basicWrappers`
**Flow Type:** Similarity
**Files:** 2
...
## [246] `lib/logging/basicWrappers.ts`
**Type:** Code File
**Exports:** logFunction, logPerformance, withLogging

---

## [247] `lib/errorHandling/basicWrappers.ts`
**Type:** Code File
...
### 🧩 Flow Group: [104] `Similarity-modernMSWMock`
**Flow Type:** Similarity
**Files:** 1
...
## [248] `lib/httpMock/modernMSWMock.ts`
**Type:** Code File
...
### 🧩 Flow Group: [105] `Similarity-routeTestUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [106] `Similarity-memoryPressure`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [107] `Similarity-connectionPool`
**Flow Type:** Similarity
**Files:** 2
...
## [252] `lib/connectionPoolHealth.md`
**Type:** Documentation
...
### 🧩 Flow Group: [108] `Similarity-cleanupManager`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [109] `Similarity-circuitBreaker`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [110] `Similarity-networkMocking`
**Flow Type:** Similarity
**Files:** 1
...
## [255] `utils/stubbing/networkMocking.ts`
**Type:** Utility
**Imports:** ../../lib/errorHandling/index.js, sinon
...
### 🧩 Flow Group: [111] `Similarity-responseMocker`
**Flow Type:** Similarity
**Files:** 1
...
## [256] `utils/helpers/responseMocker.ts`
**Type:** Utility
...
### 🧩 Flow Group: [112] `Similarity-moduleReloader`
**Flow Type:** Similarity
**Files:** 1
...
## [257] `utils/helpers/moduleReloader.ts`
**Type:** Utility
...
### 🧩 Flow Group: [113] `Similarity-functionLogger`
**Flow Type:** Similarity
**Files:** 1
...
## [258] `utils/helpers/functionLogger.ts`
**Type:** Utility
**Imports:** ../../lib/logUtils.js
...
### 🧩 Flow Group: [114] `Similarity-safeOperations`
**Flow Type:** Similarity
**Files:** 1
...
## [259] `utils/fileSystem/safeOperations.ts`
**Type:** Utility
...
### 🧩 Flow Group: [115] `Similarity-fallbackMocker`
**Flow Type:** Similarity
**Files:** 1
...
## [260] `utils/console/fallbackMocker.ts`
**Type:** Utility
...
### 🧩 Flow Group: [116] `Similarity-streamingUtils`
**Flow Type:** Similarity
**Files:** 2
...
## [261] `lib/utils/streamingUtils.js`
**Type:** Utility
...
## [262] `lib/utils/structuredLogger.ts`
**Type:** Utility
**Exports:** LogEntry, LogLevel, StructuredLoggerOptions, log, logger

---

### 🧩 Flow Group: [117] `Similarity-commonPatterns`
**Flow Type:** Similarity
**Files:** 1
...
## [263] `lib/utils/commonPatterns.ts`
**Type:** Utility
**Imports:** ./errorHandling.js
...
### 🧩 Flow Group: [118] `Similarity-wrapperFactory`
**Flow Type:** Similarity
**Files:** 1
...
## [264] `lib/errorHandling/wrapperFactory.ts`
**Type:** Code File
**Imports:** ./errorTypes.js
...
### 🧩 Flow Group: [119] `Similarity-qerrorsFallback`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [120] `Similarity-TROUBLESHOOTING`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [121] `Similarity-testDataFactory`
**Flow Type:** Similarity
**Files:** 1
...
## [267] `utils/testing/testDataFactory.ts`
**Type:** Test File
...
### 🧩 Flow Group: [122] `Similarity-jestSetupHelper`
**Flow Type:** Similarity
**Files:** 1
...
## [268] `utils/testing/jestSetupHelper.ts`
**Type:** Test File
...
### 🧩 Flow Group: [123] `Similarity-httpDataFactory`
**Flow Type:** Similarity
**Files:** 1
...
## [269] `utils/testing/httpDataFactory.ts`
**Type:** Test File
**Imports:** ../../lib/logUtils.js
...
### 🧩 Flow Group: [124] `Similarity-timerManagement`
**Flow Type:** Similarity
**Files:** 1
...
## [270] `utils/stubbing/timerManagement.ts`
**Type:** Utility
**Imports:** ../../lib/errorHandling/index.js, sinon
...
### 🧩 Flow Group: [125] `Similarity-arrayProcessing`
**Flow Type:** Similarity
**Files:** 1
...
## [271] `utils/helpers/arrayProcessing.ts`
**Type:** Utility
...
### 🧩 Flow Group: [126] `Similarity-runner-cli-test`
**Flow Type:** Similarity
**Files:** 1
...
## [272] `tests/integration/runner-cli.test.js`
**Type:** Test File
...
### 🧩 Flow Group: [127] `Similarity-validationTypes`
**Flow Type:** Similarity
**Files:** 2
**Entry Point:** lib/validation/validationTypes.ts (roleScore 0)
**Dominant Dirs:** lib/validation (2)
**Internal Deps:** 0

## [273] `lib/validation/validationTypes.ts`
**Type:** Code File
**Imports:** zod
...
## [274] `lib/validation/validationSchemas.ts`
**Type:** Code File
...
### 🧩 Flow Group: [128] `Similarity-enhancedMSWMock`
**Flow Type:** Similarity
**Files:** 1
...
## [275] `lib/httpMock/enhancedMSWMock.ts`
**Type:** Code File
**Exports:** MSWMock, createGraphQLMock, createMSWMock, createQtestsMock, mockUtils

---

### 🧩 Flow Group: [129] `Similarity-advancedMSWMock`
**Flow Type:** Similarity
**Files:** 1
...
## [276] `lib/httpMock/advancedMSWMock.ts`
**Type:** Code File
...
### 🧩 Flow Group: [130] `Similarity-runner-jest-args`
**Flow Type:** Similarity
**Files:** 6
...
## [277] `runner-jest-args.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5

---

## [278] `demo/runner-jest-args.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5

---

## [279] `config/runner-jest-args.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5

---

## [280] `config/runner-args-debug.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5, 6

---

## [281] `config/runner-jest-args-5.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5

---

## [282] `config/runner-jest-args-2.json`
**Type:** Configuration/Data
**Keys:** 0, 1, 2, 3, 4, 5, 6

---

### 🧩 Flow Group: [131] `Similarity-integration-test`
**Flow Type:** Similarity
**Files:** 2
...
## [283] `demo/integration-test.js`
**Type:** Test File

---

## [284] `tests/integration-testing.test.js`
**Type:** Test File
**Imports:** assert, sinon
...
### 🧩 Flow Group: [132] `Similarity-fileSystemConfig`
**Flow Type:** Similarity
**Files:** 1
...
## [285] `config/fileSystemConfig.ts`
**Type:** Configuration
**Exports:** allowedFileExtensions, blockedPatterns, buildDirectory, configDirectory, distDirectory, libDirectory, maxFilePathLength, maxInputLength (+3 more)

---

### 🧩 Flow Group: [133] `Similarity-memory-benchmark`
**Flow Type:** Similarity
**Files:** 2
...
## [286] `scripts/benchmarks/memory-benchmark.js`
**Type:** Code File
**Imports:** ../../dist/lib/memoryPressure.js, ../../dist/lib/performanceMonitor.js

---

## [287] `scripts/benchmarks/memory-benchmark-simple.js`
**Type:** Code File
**Imports:** ../../dist/lib/memory/snapshotManager.js, perf_hooks

---

### 🧩 Flow Group: [134] `Similarity-memoryManagement`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [135] `Similarity-concurrencyUtils`
**Flow Type:** Similarity
**Files:** 3
...
### 🧩 Flow Group: [136] `Similarity-advancedWrappers`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [137] `Similarity-fallbackHandlers`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [138] `Similarity-simple-index-test`
**Flow Type:** Similarity
**Files:** 2
...
### 🧩 Flow Group: [139] `Similarity-jestConfigFactory`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [140] `Similarity-ADVANCED-FEATURES`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [141] `Similarity-generate-cli-test`
**Flow Type:** Similarity
**Files:** 1
...
## [299] `tests/integration/generate-cli.test.js`
**Type:** Test File
...
### 🧩 Flow Group: [142] `Similarity-validationSchemas`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [143] `Similarity-importExportUtils`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [144] `Similarity-httpMockFramework`
**Flow Type:** Similarity
**Files:** 1
...
## [302] `lib/utils/httpMockFramework.ts`
**Type:** Utility
...
### 🧩 Flow Group: [145] `Similarity-clipboardPolyfill`
**Flow Type:** Similarity
**Files:** 1
...
## [303] `lib/polyfills/clipboardPolyfill.ts`
**Type:** Code File
...
### 🧩 Flow Group: [146] `Similarity-garbageCollection`
**Flow Type:** Similarity
**Files:** 1
...
## [304] `lib/memory/garbageCollection.ts`
**Type:** Code File
**Imports:** os
...
### 🧩 Flow Group: [147] `Similarity-cleanupOperations`
**Flow Type:** Similarity
**Files:** 1
...
## [305] `lib/memory/cleanupOperations.ts`
**Type:** Code File
...
### 🧩 Flow Group: [148] `Similarity-timerManager-test`
**Flow Type:** Similarity
**Files:** 1
...
## [306] `lib/utils/__tests__/timerManager.test.ts`
**Type:** Test File
**Imports:** ../timerManager.js, @jest/globals

---

### 🧩 Flow Group: [149] `Similarity-streamingValidator`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [150] `Similarity-performanceMonitor`
**Flow Type:** Similarity
**Files:** 1
...
### 🧩 Flow Group: [151] `Similarity-secure-express-app`
**Flow Type:** Similarity
**Files:** 1
...
## [309] `examples/secure-express-app.ts`
**Type:** Code File

---

### 🧩 Flow Group: [152] `Similarity-api-endpoints-test`
**Flow Type:** Similarity
**Files:** 1
...
## [310] `tests/integration/api-endpoints.test.js`
**Type:** Test File
...
### 🧩 Flow Group: [153] `Similarity-mediaQueryPolyfill`
**Flow Type:** Similarity
**Files:** 1
...
## [311] `lib/polyfills/mediaQueryPolyfill.ts`
**Type:** Code File
...
### 🧩 Flow Group: [154] `Similarity-testDiscoveryCache`
**Flow Type:** Similarity
**Files:** 1
...
## [312] `lib/optimization/testDiscoveryCache.ts`
**Type:** Test File
...
### 🧩 Flow Group: [155] `Similarity-simpleErrorLogging`
**Flow Type:** Similarity
**Files:** 1
...
## [313] `lib/errorHandling/simpleErrorLogging.ts`
**Type:** Code File
**Imports:** ./errorTypes.js
**Exports:** logError
**Functions:** logError
...
### 🧩 Flow Group: [156] `Similarity-errorHandling-test`
**Flow Type:** Similarity
**Files:** 1
...
## [314] `lib/utils/__tests__/errorHandling.test.ts`
**Type:** Test File
...
### 🧩 Flow Group: [157] `Similarity-test-utilities-test`
**Flow Type:** Similarity
**Files:** 1
...
## [315] `tests/test-utilities.test.js`
**Type:** Test File
**Imports:** assert, sinon
...
### 🧩 Flow Group: [158] `Similarity-config-local-vars-d`
**Flow Type:** Similarity
**Files:** 1
...
## [316] `@types/config-local-vars.d.ts`
**Type:** Configuration
...
### 🧩 Flow Group: [159] `Similarity-fileSystemFramework`
**Flow Type:** Similarity
**Files:** 1
...
## [317] `lib/utils/fileSystemFramework.ts`
**Type:** Utility
...
### 🧩 Flow Group: [160] `Similarity-convenienceWrappers`
**Flow Type:** Similarity
**Files:** 1
...
## [318] `lib/logging/convenienceWrappers.ts`
**Type:** Code File
...
### 🧩 Flow Group: [161] `Similarity-placeholderWrappers`
**Flow Type:** Similarity
**Files:** 1
...
## [319] `lib/errorHandling/placeholderWrappers.ts`
**Type:** Code File
**Imports:** ./errorTypes.js
...
### 🧩 Flow Group: [162] `Similarity-security-test-runner`
**Flow Type:** Similarity
**Files:** 2
...
## [320] `scripts/security-test-runner.js`
**Type:** Test File
...
## [321] `lib/security/security-test-runner.d.ts`
**Type:** Test File
**Exports:** SecurityTestRunner

---

### 🧩 Flow Group: [163] `Similarity-rateLimiter-flexible`
**Flow Type:** Similarity
**Files:** 1
...
## [322] `lib/rateLimiter-flexible.ts`
**Type:** Code File
...
### 🧩 Flow Group: [164] `Similarity-polyfillOrchestrator`
**Flow Type:** Similarity
**Files:** 1
...
## [323] `lib/polyfills/polyfillOrchestrator.ts`
**Type:** Code File
...
### 🧩 Flow Group: [165] `Similarity-performanceTestHelper`
**Flow Type:** Similarity
**Files:** 1
...
## [324] `utils/testing/performanceTestHelper.ts`
**Type:** Test File
**Imports:** ../../lib/logUtils.js
...
### 🧩 Flow Group: [166] `Similarity-integrationTestHelper`
**Flow Type:** Similarity
**Files:** 1
...
## [325] `utils/testing/integrationTestHelper.ts`
**Type:** Test File
...
### 🧩 Flow Group: [167] `Similarity-resolveStubPaths-test`
**Flow Type:** Similarity
**Files:** 1
...
## [326] `tests/integration/resolveStubPaths.test.ts`
**Type:** Test File
**Imports:** path
...
### 🧩 Flow Group: [168] `Similarity-isolationOrchestrator`
**Flow Type:** Similarity
**Files:** 1
...
## [327] `lib/testIsolation/isolationOrchestrator.ts`
**Type:** Test File
...
### 🧩 Flow Group: [169] `Similarity-ENTERPRISE-INTEGRATION`
**Flow Type:** Similarity
**Files:** 1
...
## [328] `docs/ENTERPRISE_INTEGRATION.md`
**Type:** Documentation
...
### 🧩 Flow Group: [170] `Similarity-testIsolationFramework`
**Flow Type:** Similarity
**Files:** 2
...
## [329] `lib/utils/testIsolationFramework.ts`
**Type:** Test File
**Imports:** events
...
## [330] `examples/lib/testIsolationFramework.ts`
**Type:** Test File

---

### 🧩 Flow Group: [171] `Similarity-performanceBenchmarker`
**Flow Type:** Similarity
**Files:** 1
...
## [331] `lib/utils/performanceBenchmarker.ts`
**Type:** Utility
...
### 🧩 Flow Group: [172] `Similarity-resizeObserverPolyfill`
**Flow Type:** Similarity
**Files:** 1
...
## [332] `lib/polyfills/resizeObserverPolyfill.ts`
**Type:** Code File
...
### 🧩 Flow Group: [173] `Similarity-simple-security-example`
**Flow Type:** Similarity
**Files:** 2
...
## [333] `examples/simple-security-example.ts`
**Type:** Code File
...
## [334] `examples/examples/simple-security-example.js`
**Type:** Code File
**Exports:** demonstrateMonitoring, demonstratePolicies, demonstrateRateLimiting, demonstrateSecurityTesting, demonstrateSecurityUtilities, demonstrateValidation
**Functions:** demonstrateMonitoring, demonstratePolicies, demonstrateRateLimiting, demonstrateSecurityTesting, demonstrateSecurityUtilities, demonstrateValidation, runAllSecurityExamples
...
### 🧩 Flow Group: [174] `Similarity-scalability-high-impact`
**Flow Type:** Similarity
**Files:** 1
...
## [335] `config/scalability-high-impact.json`
**Type:** Configuration/Data

---

### 🧩 Flow Group: [175] `Similarity-qerrors-resolution-test`
**Flow Type:** Similarity
**Files:** 1
...
## [336] `tests/integration/qerrors-resolution.test.ts`
**Type:** Test File
**Imports:** @bijikyu/qtests/setup, @jest/globals

---

### 🧩 Flow Group: [176] `Similarity-performance-testing-test`
**Flow Type:** Similarity
**Files:** 1
...
## [337] `tests/performance-testing.test.js`
**Type:** Test File
**Imports:** assert, sinon
...
### 🧩 Flow Group: [177] `Similarity-concurrency-testing-test`
**Flow Type:** Similarity
**Files:** 1
...
## [338] `tests/concurrency-testing.test.js`
**Type:** Test File
**Imports:** assert, sinon
...
### 🧩 Flow Group: [178] `Similarity-advanced-edge-cases-test`
**Flow Type:** Similarity
**Files:** 1
...
## [339] `tests/advanced-edge-cases.test.js`
**Type:** Test File
**Imports:** assert, sinon
...
### 🧩 Flow Group: [179] `Similarity-demonstrate-improvements`
**Flow Type:** Similarity
**Files:** 1
...
## [340] `scripts/demonstrate-improvements.js`
**Type:** Code File

---

### 🧩 Flow Group: [180] `Similarity-working-security-example`
**Flow Type:** Similarity
**Files:** 2
...
## [341] `examples/working-security-example.ts`
**Type:** Code File
**Imports:** ./lib/security/SecurityTestFramework.js
...
## [342] `examples/working-security-example.js`
**Type:** Code File
...
### 🧩 Flow Group: [181] `Similarity-minimal-security-example`
**Flow Type:** Similarity
**Files:** 1
...
## [343] `examples/minimal-security-example.ts`
**Type:** Code File
**Imports:** ./lib/security/SecurityTestFramework.js
...
### 🧩 Flow Group: [182] `Similarity-core-function-tests-test`
**Flow Type:** Similarity
**Files:** 1
...
## [344] `tests/integration/core-function-tests.test.ts`
**Type:** Test File
...
### 🧩 Flow Group: [183] `Similarity-streamingValidationLogic`
**Flow Type:** Similarity
**Files:** 1
...
## [345] `lib/validation/streamingValidationLogic.ts`
**Type:** Code File
**Imports:** ./validationTypes.js, zod
...
### 🧩 Flow Group: [184] `Similarity-legacyStreamingValidator`
**Flow Type:** Similarity
**Files:** 1
...
## [346] `lib/validation/legacyStreamingValidator.ts`
**Type:** Code File
...
### 🧩 Flow Group: [185] `Similarity-demo--server--app--get-test`
**Flow Type:** Similarity
**Files:** 2
...
## [347] `tests/integration/demo__server__app__get.test.js`
**Type:** Test File
**Imports:** @bijikyu/qtests/lib/routeTestUtils

---

## [348] `tests/integration/demo__server__routes__hello__get.test.js`
**Type:** Test File
**Imports:** @bijikyu/qtests/lib/routeTestUtils

---

### 🧩 Flow Group: [186] `Similarity-intersectionObserverPolyfill`
**Flow Type:** Similarity
**Files:** 1
...
## [349] `lib/polyfills/intersectionObserverPolyfill.ts`
**Type:** Code File
...
### 🧩 Flow Group: [187] `Similarity-security-integration-example`
**Flow Type:** Similarity
**Files:** 1
...
## [350] `examples/examples/security-integration-example.js`
**Type:** Code File
**Imports:** ../lib/security/SecurityMonitor.js, ../lib/security/SecurityPolicyManager.js, ../lib/security/SecurityValidator.js
**Exports:** demonstrateBasicValidation, demonstrateRateLimiting, demonstrateSecurityMonitoring, demonstrateSecurityPolicies, demonstrateSecurityReport
**Functions:** demonstrateBasicValidation, demonstrateRateLimiting, demonstrateSecurityMonitoring, demonstrateSecurityPolicies, demonstrateSecurityReport, runSecurityIntegrationExamples
...
### 🧩 Flow Group: [188] `Similarity-simple-scalability-test-clean`
**Flow Type:** Similarity
**Files:** 1
...
## [351] `scripts/simple-scalability-test-clean.js`
**Type:** Test File
...
### 🧩 Flow Group: [189] `Similarity-comprehensive-function-tests-test`
**Flow Type:** Similarity
**Files:** 1
...
## [352] `tests/integration/comprehensive-function-tests.test.ts`
**Type:** Test File
**Imports:** @jest/globals, sinon
